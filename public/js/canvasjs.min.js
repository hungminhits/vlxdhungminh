...
*/
(function() {
    function T(a, c) { a.prototype = Pa(c.prototype);
    ...
    function qa(a) { a.indexOf || (a.indexOf = Qa);
        return a }
    ...
    function J(a, c, b, d) {
        return a.addEventListener ? (a.addEventListener(c, b, d || !1), b) : a.attachEvent ? (d = function(d) { d = d || window.event;
    ...
    function Ma(a, c, b) {
        ...
        c = !0;
        for (b = 0; 4 > b; b++)
            if (a[b] !== a[b + 4] | a[b] !== a[b + 8] | a[b] !== a[b + 12]) { c = !1;
                break }
        return c ? a[0] << 16 | a[1] <<
            8 | a[2] : 0
    }
    ...
    function ra(a, c, b) {
        if (u && Na) {
            ...
            a.width = c * Q;
            a.height = b * Q;
            za !== sa && (a.style.width = c + "px", a.style.height = b + "px", d.scale(Q, Q)) } else a.width = c, a.height = b }

    function Ra(a) {
        if (!Aa) {
            var c = !1,
                b = !1;
            "undefined" === typeof aa.Chart.creditHref ? (a.creditHref = "https://canvasjs.com/", a.creditText =
        ...
        if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
            ...
            this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ia(this.ctx), u ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ea(d, f), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
                ...
                this._toolBar.style.cssText = "position: absolute; right: 1px; top: 1px;", this._canvasJSContainer.appendChild(this._toolBar), this.bounds = { x1: 0, y1: 0, x2: this.width, y2: this.height }, J(this.overlaidCanvas, "click", function(a) { b._mouseEventHandler(a) }), J(this.overlaidCanvas, "mousemove", function(a) { b._mouseEventHandler(a) }), J(this.overlaidCanvas, "mouseup", function(a) { b._mouseEventHandler(a) }), J(this.overlaidCanvas, "mousedown", function(a) { b._mouseEventHandler(a);
                    X(b._dropdownMenu) }), J(this.overlaidCanvas, "mouseout",
    ...
    function ua(a, c) {
        for (var b = [], d, f = 0; f < a.length; f++)
            if (0 == f) b.push(a[0]);
                ...
                var l = (a[k].x - a[g].x) / d;
                d = (a[k].y - a[g].y) / d;
                b[b.length] = a[h].x > a[g].x && 0 < l || a[h].x < a[g].x && 0 > l ? { x: a[h].x + l / 3, y: a[h].y + d / 3 } : { x: a[h].x, y: a[h].y + d / 9 };
                h = f;
                g = 0 === h ? 0 : h - 1;
                k = h === a.length - 1 ? h : h + 1;
    ...
    function ha(a, c, b, d, f) { "undefined" === typeof f && (f = 0);
        this._padding = f;
        this._x1 = a;
        this._y1 = c;
        this._x2 = b;
    ...
    function V(a, c) { V.base.constructor.call(this, "TextBlock", c);
        this.ctx = a;
        this._isDirty = !0;
    ...
    function ma(a, c) {
        ...
        if (x(this.options.margin) && a.options.subtitles)
            for (var b = a.options.subtitles, d = 0; d < b.length; d++)
                if ((x(b[d].horizontalAlign) && "center" === this.horizontalAlign || b[d].horizontalAlign === this.horizontalAlign) && (x(b[d].verticalAlign) && "top" === this.verticalAlign || b[d].verticalAlign === this.verticalAlign) && !b[d].dockInsidePlotArea === !this.dockInsidePlotArea) { this.margin = 0;
                    break }
    ...
    function R(a, c) { R.base.constructor.call(this, "ToolTip", c, a.theme, a);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
    ...
    var y = {},
        ...
        pa = { en: {} },
        fa = { colorSet1: "#369EAD #C24642 #7F6084 #86B402 #A2D1CF #C8B631 #6DBCEB #52514E #4F81BC #A064A1 #F79647".split(" "), colorSet2: "#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #33558B".split(" "), colorSet3: "#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ") },
        ga = {
            theme1: {
                ...
                Subtitle: { fontFamily: u ? "Calibri, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri", fontSize: 16, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 },
                Axis: {
                    titleFontSize: 26,
                ...
                DataSeries: { indexLabelFontColor: "grey", indexLabelFontFamily: u ? "Calibri, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri", indexLabelFontSize: 18, indexLabelLineThickness: 1 }
            },
            theme2: {
            ...
            for (var z = 0; h && z < h.length; z++)
                if (c = h[z], "." === c && 0 > l) l = z;
                    ...
                    if ("%" === c) k *= 100;
                        ...
                        continue } else if ("," === c[0] && "." === c[c.length - 1]) { k /= Math.pow(1E3, c.length - 1);
                        l = z + c.length - 1;
                        continue } else "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || (r = !0);
            ...
            for (r = h = z = e = l = 0; 0 < m.length;)
                if (c = m.pop(), "#" === c || "0" === c)
                    if (l++, l === n) {
                        ...
                        for (; 0 < v.length;) b = v.pop() + b, r++, 0 === r % h && (z === q && 0 < v.length) && (b = g + b) } else 0 < k.length ? (b = k.pop() + b, e++, r++) : "0" === c && (b = "0" + b, e++, r++), 0 === r % h && (z === q && 0 < k.length) && (b = g + b);
    ...
    (function() {
        ...
        y.pro = { sCH: aa[y.fSDec([178, 215, 208, 225, 227])][y.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])] };
        y.fAWm = function(a) {
            ...
            if (!Aa) try {
                ...
                a: {
                    ...
                    if (f && 0 < f.length || g) {
                        ...
                        g && (l = g);
                        k = { ckVal: Number(h[0]), lSVal: l ? Number(l.val) : null };
                        g = null;
    ...
    L.prototype.isBeingTracked = function(a) { this.options._oldOptions || (this.options._oldOptions = {});
    ...
    L.prototype.removeEventListener = function(a, c) {
        if (a && c && this._eventListeners[a])
            for (var b = this._eventListeners[a], d = 0; d < b.length; d++)
                if (b[d].eventHandler === c) { b[d].splice(d, 1);
                    break } };
    ...
    A.prototype._updateOptions = function() {
        ...
        if (!this._dropdownMenu && this.exportEnabled && u) {
            ...
            J(this._dropdownMenu, "blur", function() { X(a._dropdownMenu);
    ...
    A.prototype.render = function(a) {
        ...
        if (0 < this._axes.length &&
            ...
            for (a = 0; a < this._axes.length; a++)
                if (null !== this._axes[a].viewportMinimum || null !== this._axes[a].viewportMaximum) { b = !0;
                    break }
        ...
        var l = this;
        0 < d.length ? (l.disableToolTip = !0, l._animator.animate(200, l.animationDuration, function(a) { l.ctx.clearRect(0, 0, l.width, l.height);
            ...
            l.dispatchEvent("dataAnimationIterationEnd", { chart: l }) }, function() {
            d = [];
            for (var a =
    ...
    A.prototype.attachPlotAreaEventHandlers =
        function() { this.attachEvent({ context: this, chart: this, mousedown: this._plotAreaMouseDown, mouseup: this._plotAreaMouseUp, mousemove: this._plotAreaMouseMove, cursor: this.zoomEnabled ? "col-resize" : "move", cursor: this.panEnabled ? "move" : "default", capture: !0, bounds: this.plotArea }) };
        ...
        for (var a = "", c = 0; c < this.data.length; c++)
            if (a = this.data[c], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= A._supportedChartTypes.indexOf(a.type)) {
                for (var b = null, d = !1, f = null, g = !1, k =
                    ...
                    if (this.plotInfo.plotTypes[k].type === a.type) { d = !0;
                ...
                for (k = 0; k < b.plotUnits.length; k++)
                    if (b.plotUnits[k].axisYType === a.axisYType && b.plotUnits[k].axisXType === a.axisXType && b.plotUnits[k].axisYIndex === a.axisYIndex && b.plotUnits[k].axisXIndex === a.axisXIndex) { g = !0;
                        f = b.plotUnits[k];
                        break }
                g || (f = {
                    type: a.type,
                ...
                for (l = 0; l < h.dataPoints.length; l++) {
                    ...
                    if (0 < l) {
                        if (a.axisX.logarithmic) {
                            ...
                            1 > r && (r = 1 / r);
                            b.minDiff > r && 1 !== r && (b.minDiff = r) } else r = d - h.dataPoints[l - 1].x, 0 > r && (r *= -1), b.minDiff > r && 0 !== r && (b.minDiff = r);
                ...
                for (e = 0; e < n.dataPoints.length; e++) {
                    ...
                    if (0 < e) {
                        if (a.axisX.logarithmic) {
                            ...
                            1 > t && (t = 1 / t);
                            b.minDiff > t && 1 !== t && (b.minDiff = t) } else t = d - n.dataPoints[e - 1].x, 0 > t && (t *= -1), b.minDiff > t && 0 !== t && (b.minDiff = t);
                    ...
                    for (n = 0; n < p.dataPoints.length; n++) {
                        ...
                        if (0 < n) {
                            if (a.axisX.logarithmic) {
                                ...
                                1 > v && (v = 1 / v);
                                b.minDiff > v && 1 !== v && (b.minDiff = v) } else v = d - p.dataPoints[n - 1].x, 0 > v && (v *= -1), b.minDiff > v && 0 !== v && (b.minDiff = v);
                    ...
                    if (!(d < z) || n) {
                        ...
                        if (b.viewPortMin === d && f)
                            for (t = 0; t < f.length; t++)
                                if (null === f[t] && q < d) { b.viewPortMin = q;
                                    break }
    ...
    A.prototype.getDataPointAtXY = function(a, c, b) {
        ...
        for (b = 0; b < d.length; b++)
            if ("line" === d[b].dataSeries.type || "stepLine" === d[b].dataSeries.type || "area" === d[b].dataSeries.type || "stepArea" === d[b].dataSeries.type)
                if (f = K("markerSize", d[b].dataPoint, d[b].dataSeries) || 8, d[b].distance <= f / 2) { c = !0;
                    break }
    ...
    A.prototype.getObjectAtXY =
        function(a, c, b) {
            ...
            return d };
    A.prototype.getAutoFontSize = function(a, c, b) { a /= 400;
    ...
    A.prototype.attachEvent = function(a) { this._events.push(a) };
    ...
    A.prototype._dispatchRangeEvent = function(a, c) {
        ...
        for (var f = 0; f < d.length; f++)
            ...
            for (g =
                0; g < this.axisY2.length; g++) b[d[f]].push({ viewportMinimum: this[d[f]][g].sessionVariables.newViewportMinimum, viewportMaximum: this[d[f]][g].sessionVariables.newViewportMaximum });
        else if ("axisX" === d[f])
    ...
    A.prototype._plotAreaMouseDown = function(a, c) { this.isDrag = !0;
    ...
    A.prototype.validateRegion = function(a, c, b, d, f) {
        ...
        for (g = 0; g < m.length; g++) {
            ...
            if (isFinite(k.dataInfo.minDiff))
                if (!(k.logarithmic && e / n < Math.pow(k.dataInfo.minDiff, 3) || !k.logarithmic && Math.abs(e - n) < 3 * Math.abs(k.dataInfo.minDiff) || n < k.minimum || e > k.maximum)) l.push(k), p.push({ val1: n, val2: e }), h = !0;
                else if (!f) { h = !1;
                break } }
        return { isValid: h, axesWithValidRange: l, axesRanges: p }
    };
    ...
    A.prototype.renderIndexLabels = function(a) {
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            ...
            if (m.dataSeries.indexLabelFormatter || m.dataPoint.indexLabelFormatter) t = { chart: this, dataSeries: m.dataSeries, dataPoint: m.dataPoint, index: m.indexKeyword, total: v.total, percent: v.percent };
            ...
            if (null !== w && "" !== w) {
                var v = K("indexLabelPlacement", m.dataPoint, m.dataSeries),
                    ...
                    y = !1,
                    q = new V(c, { x: 0, y: 0, maxWidth: f ? f : 0.5 * this.width, maxHeight: g ? 5 * l : 1.5 * l, angle: "horizontal" === t ? 0 : -90, text: w, padding: 0, backgroundColor: q, horizontalAlign: "left", fontSize: l, fontFamily: n, fontWeight: k, fontColor: h, fontStyle: e, textBaseline: "top" });
                q.measureText();
                m.dataSeries.indexLabelMaxWidth = q.maxWidth;
                if (0 <= p.indexOf("stackedarea100")) {
                    if (m.point.x < b.x1 || m.point.x > b.x2 || m.point.y < b.y1 - 1 || m.point.y > b.y2 + 1) continue } else if (0 <= p.indexOf("line") || 0 <= p.indexOf("area") ||
                    0 <= p.indexOf("bubble") || 0 <= p.indexOf("scatter")) {
                    if (m.dataPoint.x < Y.viewportMinimum || m.dataPoint.x > Y.viewportMaximum || m.dataPoint.y < B.viewportMinimum || m.dataPoint.y > B.viewportMaximum) continue } else if (0 <= p.indexOf("column")) {
                    if (m.dataPoint.x < Y.viewportMinimum || m.dataPoint.x > Y.viewportMaximum || m.bounds.y1 > b.y2 || m.bounds.y2 < b.y1) continue } else if (0 <= p.indexOf("bar")) {
                    if (m.dataPoint.x < Y.viewportMinimum || m.dataPoint.x > Y.viewportMaximum || m.bounds.x1 > b.x2 || m.bounds.x2 < b.x1) continue } else if (m.dataPoint.x <
                    ...
                    for (var v = !1, r = 0; r < h.length; r++)
                        if (s = h[r].x.getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                            ...
                            if ("number" !== typeof h[r].y) 0 < r && !(k.connectNullData || v || q) && (c.stroke(), u && b.stroke()), v = !0;
                                ...
                                this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: g, dataPointIndex: r, x1: s, y1: z };
                                ...
                                if (0 < h[r].markerSize || 0 < k.markerSize) {
                                    ...
                                    d.push(w);
                                    t = E(t);
                                    u && d.push({ x: s, y: z, ctx: b, type: w.type, size: w.size, color: t, borderColor: t, borderThickness: w.borderThickness }) }(h[r].indexLabel || k.indexLabel || h[r].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: h[r], dataSeries: k, point: { x: s, y: z }, direction: 0 > h[r].y === a.axisY.reversed ? 1 : -1, color: n })
                            }
                    c.stroke();
                    u && b.stroke()
                }
                    ...
                    for (var v = !1, r = 0; r < h.length; r++)
                        if (s = h[r].getTime ? h[r].x.getTime() :
                            ...
                            if ("number" !== typeof h[r].y) 0 < r && !(k.connectNullData || v || q) && (c.stroke(), u && b.stroke()), v = !0;
                                ...
                                this._eventManager.objectMap[w] = { id: w, objectType: "dataPoint", dataSeriesIndex: g, dataPointIndex: r, x1: s, y1: z };
                                ...
                                if (0 < h[r].markerSize || 0 < k.markerSize) t = k.getMarkerProperties(r, s, z, c), d.push(t), w = E(w), u && d.push({ x: s, y: z, ctx: b, type: t.type, size: t.size, color: w, borderColor: w, borderThickness: t.borderThickness });
                    ...
                    for (z = !1, r = 0; r < l.length; r++)
                        if (s = l[r].getTime ? l[r].x.getTime() : l[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !z)))
                            if ("number" !==
                                ...
                                this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: r, x1: s, y1: z };
                                v[v.length] = { x: s, y: z };
                                ...
                                if (0 < l[r].markerSize || 0 < h.markerSize) {
                                    ...
                                    f.push(w);
                                    t = E(t);
                                    u && f.push({ x: s, y: z, ctx: d, type: w.type, size: w.size, color: t, borderColor: t, borderThickness: w.borderThickness }) }(l[r].indexLabel || h.indexLabel || l[r].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "spline",
                                    dataPoint: l[r],
                                    dataSeries: h,
                                    point: { x: s, y: z },
    ...
    A.prototype.renderColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 < e.length)
                    for (var q = 5 < p && n.bevelEnabled ? !0 : !1, f = 0; f < e.length; f++)
                        if (e[f].getTime ? h = e[f].x.getTime() : h = e[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            b = n.dataPointIds[f];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: f, x1: g, y1: k, x2: r, y2: s };
                            b = E(b);
            ...
            return { source: c, dest: this.plotArea.ctx, animationCallback: F.yScaleAnimation, easingFunction: F.easing.easeOutQuart, animationBase: a }
        }
    };
                    ...
                    for (h = 0; h < r.length; h++)
                        if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                            ...
                            if (a.axisY.logarithmic) k[b] = r[h].y + (k[b] ? k[b] : 0), 0 < k[b] && (l = a.axisY.convertValueToPixel(k[b]), t = f[b] ? f[b] : m, f[b] = l);
                                ...
                                l -= w;
                                t = m - w;
                                f[b] = w + (t - l) } else w = g[b] ? g[b] : 0, t = l + w, l = m + w, g[b] = w + (t - l);
                            ...
                            (r[h].indexLabel || q.indexLabel || r[h].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn", dataPoint: r[h], dataSeries: q, point: { x: d, y: 0 <= r[h].y ? l : t }, direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: z, y1: Math.min(l, t), x2: v, y2: Math.max(l, t) }, color: b })
                        }
                }
            }
            c.restore();
                    ...
                    for (var s = 5 < n && q.bevelEnabled ? !0 : !1, h = 0; h < r.length; h++)
                        if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin ||
                            ...
                            var z = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0,
                                v = z + n << 0,
                                t;
                            if (a.axisY.logarithmic) { k[b] = l + (k[b] ? k[b] : 0);
                                if (0 >= k[b]) continue;
                                l = a.axisY.convertValueToPixel(k[b]);
                                t = f[b] ? f[b] : m;
                                f[b] = l } else if (l = a.axisY.convertValueToPixel(l), 0 <= r[h].y) {
                                var w = f[b] ? f[b] : 0;
                                l -= w;
                                t = m - w;
                                f[b] = w + (t - l) } else w = g[b] ? g[b] : 0, t = l + w, l = m + w, g[b] = w + (t - l);
                            ...
                            M(c, z, l, v, t, b, 0, null, s && 0 <= r[h].y, 0 > r[h].y && s, !1, !1, q.fillOpacity);
                            b = q.dataPointIds[h];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: h, x1: z, y1: l, x2: v, y2: t };
                            b = E(b);
                            u && M(this._eventManager.ghostCtx, z, l, v, t, b, 0, null, !1, !1, !1, !1);
                            (r[h].indexLabel || q.indexLabel || r[h].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                dataPoint: r[h],
                                dataSeries: q,
                                point: { x: d, y: 0 <= r[h].y ? l : t },
                                direction: 0 >
                                    r[h].y === a.axisY.reversed ? 1 : -1,
                                bounds: { x1: z, y1: Math.min(l, t), x2: v, y2: Math.max(l, t) },
                                color: b
                            })
                        }
            }
    ...
    A.prototype.renderBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)
                        if (e[f].getTime ? h = e[f].x.getTime() : h = e[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            b = n.dataPointIds[f];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: f, x1: s, y1: k, x2: g, y2: r };
                            b = E(b);
                            ...
                            (e[f].indexLabel || n.indexLabel || e[f].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                dataPoint: e[f],
                                dataSeries: n,
                                point: { x: 0 <= e[f].y ? g : s, y: k + (r - k) / 2 },
                                direction: 0 > e[f].y === a.axisY.reversed ? 1 : -1,
                                bounds: { x1: Math.min(s, g), y1: k, x2: Math.max(s, g), y2: r },
                                color: b
                            })
                        }
                }
            ...
            return { source: c, dest: this.plotArea.ctx, animationCallback: F.xScaleAnimation, easingFunction: F.easing.easeOutQuart, animationBase: a }
        }
    };
                    ...
                    for (h = 0; h < r.length; h++)
                        if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                            ...
                            if (a.axisY.logarithmic) k[b] =
                                ...
                                t = m + w;
                                l += w;
                                f[b] = w + (l - t) } else w = g[b] ? g[b] : 0, t = l - w, l = m - w, g[b] = w + (l - t);
                            b = r[h].color ? r[h].color : q._colorSet[h % q._colorSet.length];
                            M(c, t, z, l, v, b, 0, null, s, !1, !1, !1, q.fillOpacity);
                            b = q.dataPointIds[h];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: h, x1: t, y1: z, x2: l, y2: v };
                            b = E(b);
                            u && M(this._eventManager.ghostCtx,
                                t, z, l, v, b, 0, null, !1, !1, !1, !1);
                            (r[h].indexLabel || q.indexLabel || r[h].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: r[h], dataSeries: q, point: { x: 0 <= r[h].y ? l : t, y: d }, direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(t, l), y1: z, x2: Math.max(t, l), y2: v }, color: b })
                        }
                }
            }
            c.restore();
                    ...
                    for (h = 0; h < r.length; h++)
                        if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" ===
                            ...
                            var v = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0,
                                t = v + n << 0;
                            if (a.axisY.logarithmic) { k[b] = z + (k[b] ? k[b] : 0);
                                if (0 >= k[b]) continue;
                                z = f[b] ? f[b] : m;
                                f[b] = l = a.axisY.convertValueToPixel(k[b]) } else if (l = a.axisY.convertValueToPixel(z), 0 <= r[h].y) {
                                var w = f[b] ? f[b] : 0;
                                z = m + w;
                                l += w;
                                f[b] = w + (l - z) } else w = g[b] ? g[b] : 0, z = l - w, l = m - w, g[b] = w + (l - z);
                            b = r[h].color ? r[h].color : q._colorSet[h % q._colorSet.length];
                            M(c, z, v,
                                l, t, b, 0, null, s, !1, !1, !1, q.fillOpacity);
                            b = q.dataPointIds[h];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: h, x1: z, y1: v, x2: l, y2: t };
                            b = E(b);
    ...
    A.prototype.renderArea = function(a) {
        function c() {
            t && (0 < m.lineThickness && b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? v = z : 0 > a.axisY.viewportMaximum ? v = g.y1 : 0 < a.axisY.viewportMinimum && (v = f.y2), b.lineTo(q, v),
                b.lineTo(t.x, v), b.closePath(), b.globalAlpha = m.fillOpacity, b.fill(), b.globalAlpha = 1, u && (d.lineTo(q, v), d.lineTo(t.x, v), d.closePath(), d.fill()), b.beginPath(), b.moveTo(q, r), d.beginPath(), d.moveTo(q, r), t = { x: q, y: r })
        }
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = this._eventManager.ghostCtx,
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var l = a.dataSeriesIndexes[h],
                    ...
                    p = m.dataPoints,
                    k = m.id;
                this._eventManager.objectMap[k] = { objectType: "dataSeries", dataSeriesIndex: l };
                k = E(k);
                d.fillStyle = k;
                var k = [],
                    n = !0,
                        ...
                        if (s = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !N)))
                            if ("number" !== typeof p[e].y) m.connectNullData || (N || n) || c(), N = !0;
                                ...
                                n || N ? (!n && m.connectNullData ? (b.setLineDash && (m.options.nullDataLineDashType ||
                                    B === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (b.stroke(), B = m.nullDataLineDashType, b.setLineDash(A)), b.lineTo(q, r), u && d.lineTo(q, r)) : (b.beginPath(), b.moveTo(q, r), u && (d.beginPath(), d.moveTo(q, r)), t = { x: q, y: r }), N = n = !1) : (b.lineTo(q, r), u && d.lineTo(q, r), 0 == e % 250 && c());
                                ...
                                this._eventManager.objectMap[H] = { id: H, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: e, x1: q, y1: r };
                                0 !== p[e].markerSize && (0 < p[e].markerSize || 0 < m.markerSize) && (s = m.getMarkerProperties(e, q, r, b), k.push(s), H = E(H), u && k.push({ x: q, y: r, ctx: d, type: s.type, size: s.size, color: H, borderColor: H, borderThickness: s.borderThickness }));
                    ...
                    for (q = !1; n < p.length; n++)
                        if (e = p[n].x.getTime ?
                            ...
                            if ("number" !== typeof p[n].y) 0 < n && !q && (m.connectNullData ? b.setLineDash && (0 < v.length && (m.options.nullDataLineDashType || !p[n - 1].lineDashType)) && (v[v.length - 1].newLineDashArray = B, y = m.nullDataLineDashType) : (c(), v = [])), q = !0;
                                ...
                                }(p[n].indexLabel || m.indexLabel || p[n].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "splineArea", dataPoint: p[n], dataSeries: m, point: { x: e, y: q }, direction: 0 > p[n].y === a.axisY.reversed ? 1 : -1, color: t });
                                q = !1
                            }
                    c();
                    P.drawMarkers(k)
    ...
    A.prototype.renderStepArea =
        function(a) {
            function c() { t && (0 < m.lineThickness && b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? v = z : 0 > a.axisY.viewportMaximum ? v = g.y1 : 0 < a.axisY.viewportMinimum && (v = f.y2), b.lineTo(q, v), b.lineTo(t.x, v), b.closePath(), b.globalAlpha = m.fillOpacity, b.fill(), b.globalAlpha = 1, u && (d.lineTo(q, v), d.lineTo(t.x, v), d.closePath(), d.fill()), b.beginPath(), b.moveTo(q, r), d.beginPath(), d.moveTo(q, r), t = { x: q, y: r }) }
            var b = a.targetCanvasCtx || this.plotArea.ctx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var d =
                        ...
                        for (; e < p.length; e++)
                            if (s = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !w))) {
                                ...
                                typeof p[e].y ? (m.connectNullData || (w || n) || c(), w = !0) : (q = a.axisX.convertValueToPixel(s), r = a.axisY.convertValueToPixel(p[e].y), n || w ? (!n && m.connectNullData ? (b.setLineDash && (m.options.nullDataLineDashType || A === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (b.stroke(), A = m.nullDataLineDashType, b.setLineDash(C)), b.lineTo(q, H), b.lineTo(q, r), u && (d.lineTo(q, H), d.lineTo(q, r))) : (b.beginPath(), b.moveTo(q, r), u && (d.beginPath(), d.moveTo(q, r)), t = { x: q, y: r }), w = n = !1) : (b.lineTo(q, H), u && d.lineTo(q, H), b.lineTo(q,
                                    ...
                                    r, b), k.push(s), H = E(H), u && k.push({ x: q, y: r, ctx: d, type: s.type, size: s.size, color: H, borderColor: H, borderThickness: s.borderThickness })), (p[e].indexLabel || m.indexLabel || p[e].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stepArea", dataPoint: p[e], dataSeries: m, point: { x: q, y: r }, direction: 0 > p[e].y === a.axisY.reversed ? 1 : -1, color: x }))
                            }
                        c();
                        P.drawMarkers(k)
                    }
    ...
    A.prototype.renderStackedArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                h = [];
                p = t.id;
                this._eventManager.objectMap[p] = { objectType: "dataSeries", dataSeriesIndex: v };
                p = E(p);
                s.fillStyle = p;
                if (0 < l.length) {
                    var d = t._colorSet[0],
                    ...
                    for (var N = !0, p = 0; p < l.length; p++) {
                        ...
                        var H = null,
                            ...
                            w[t.dataPointIndexes[q]] : { x: q, y: null };
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !N)))
                            if ("number" !== typeof H.y) t.connectNullData || (N || z) || c(), N = !0;
                                ...
                                var ca = k[q] ? k[q] : 0;
                                if (a.axisY.logarithmic) { m[q] = H.y + (m[q] ? m[q] : 0);
                                    if (0 >= m[q]) continue;
                                    e = a.axisY.convertValueToPixel(m[q]) } else e = a.axisY.convertValueToPixel(H.y), e -= ca;
                                h.push({ x: n, y: r - ca });
                                k[q] = r - e;
                                z || N ? (!z && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType ||
                                    B === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), B = t.nullDataLineDashType, b.setLineDash(A)), b.lineTo(n, e), u && s.lineTo(n, e)) : (b.beginPath(), b.moveTo(n, e), u && (s.beginPath(), s.moveTo(n, e))), N = z = !1) : (b.lineTo(n, e), u && s.lineTo(n, e), 0 == p % 250 && (c(), b.moveTo(n, e), u && s.moveTo(n, e), h.push({ x: n, y: r - ca })));
                                p < w.length - 1 && (y !== (w[p].lineColor || x) || B !== (w[p].lineDashType || t.lineDashType)) && (c(), b.beginPath(), b.moveTo(n, e), h.push({ x: n, y: r - ca }), y = w[p].lineColor || x, b.strokeStyle = y, b.setLineDash &&
                                ...
                                if (0 <= t.dataPointIndexes[q]) {
                                    ...
                                    this._eventManager.objectMap[da] = { id: da, objectType: "dataPoint", dataSeriesIndex: v, dataPointIndex: t.dataPointIndexes[q], x1: n, y1: e } }
                                ...
                                (H.indexLabel || t.indexLabel || H.indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea", dataPoint: H, dataSeries: t, point: { x: n, y: e }, direction: 0 > w[p].y === a.axisY.reversed ? 1 : -1, color: d })
                            }
                    }
                    c();
                    b.moveTo(n, e);
    ...
    A.prototype.renderStackedArea100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                z = !0;
                d = t.id;
                this._eventManager.objectMap[d] = { objectType: "dataSeries", dataSeriesIndex: v };
                d = E(d);
                s.fillStyle = d;
                h = [];
                if (0 < l.length) {
                    ...
                    for (var N = !0, p = 0; p < l.length; p++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !N)))
                            if ("number" !== typeof H.y) t.connectNullData || (N || z) || c(), N = !0;
                                ...
                                n = a.axisX.convertValueToPixel(q);
                                var da = k[q] ? k[q] : 0;
                                if (a.axisY.logarithmic) { m[q] = ca + (m[q] ? m[q] : 0);
                                    if (0 >= m[q]) continue;
                                    e = a.axisY.convertValueToPixel(m[q]) } else e = a.axisY.convertValueToPixel(ca), e -= da;
                                h.push({ x: n, y: r - da });
                                k[q] = r - e;
                                z || N ? (!z &&
                                    t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType || B === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), B = t.nullDataLineDashType, b.setLineDash(A)), b.lineTo(n, e), u && s.lineTo(n, e)) : (b.beginPath(), b.moveTo(n, e), u && (s.beginPath(), s.moveTo(n, e))), N = z = !1) : (b.lineTo(n, e), u && s.lineTo(n, e), 0 == p % 250 && (c(), b.moveTo(n, e), u && s.moveTo(n, e), h.push({ x: n, y: r - da })));
                                p < w.length - 1 && (y !== (w[p].lineColor || x) || B !== (w[p].lineDashType || t.lineDashType)) && (c(), b.beginPath(), b.moveTo(n, e),
                                    h.push({ x: n, y: r - da }), y = w[p].lineColor || x, b.strokeStyle = y, b.setLineDash && (w[p].lineDashType ? (B = w[p].lineDashType, b.setLineDash(G(B, t.lineThickness))) : (B = t.lineDashType, b.setLineDash(C))));
                                if (0 <= t.dataPointIndexes[q]) {
                                    var Fa = t.dataPointIds[t.dataPointIndexes[q]];
                                    this._eventManager.objectMap[Fa] = { id: Fa, objectType: "dataPoint", dataSeriesIndex: v, dataPointIndex: t.dataPointIndexes[q], x1: n, y1: e } }
                                0 <= t.dataPointIndexes[q] && 0 !== H.markerSize && (0 < H.markerSize || 0 < t.markerSize) && (q = t.getMarkerProperties(p, n, e, b),
                                    g.push(q), markerColor = E(Fa), u && g.push({ x: n, y: e, ctx: s, type: q.type, size: q.size, color: markerColor, borderColor: markerColor, borderThickness: q.borderThickness }));
                                (H.indexLabel || t.indexLabel || H.indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea100", dataPoint: H, dataSeries: t, point: { x: n, y: e }, direction: 0 > w[p].y === a.axisY.reversed ? 1 : -1, color: d })
                            }
                    }
                    c();
                    b.moveTo(n, e);
                ...
                if (m = a.dataSeriesIndexes[l], p = this.data[m], n = p.dataPoints, 0 < n.length)
                    for (c.strokeStyle =
                        ...
                        if (f = n[d].getTime ? f = n[d].x.getTime() : f = n[d].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[d].y) {
                            ...
                            this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: d, x1: f, y1: g, size: r };
                            r = E(s);
                ...
                if (0 < m.length) {
                    ...
                    for (var p = 0, n = 0, d = 0; d < m.length; d++)
                        if (f = m[d].getTime ? f = m[d].x.getTime() : f = m[d].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[d].y) {
                            ...
                            c.globalAlpha = 1;
                            Math.sqrt((p - f) * (p - f) + (n - g) * (n - g)) < Math.min(e.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = l.dataPointIds[d], this._eventManager.objectMap[p] = { id: p, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: d, x1: f, y1: g }, p = E(p), u && P.drawMarker(e.x, e.y, this._eventManager.ghostCtx, e.type, e.size, p, p, e.borderThickness), (m[d].indexLabel || l.indexLabel || m[d].indexLabelFormatter || l.indexLabelFormatter) &&
                                this._indexLabels.push({ chartType: "scatter", dataPoint: m[d], dataSeries: l, point: { x: f, y: g }, direction: 1, bounds: { x1: f - e.size / 2, y1: g - e.size / 2, x2: f + e.size / 2, y2: g + e.size / 2 }, color: null }), p = f, n = g)
                        }
                }
            }
            c.restore();
                    ...
                    for (var z = 5 < n && r.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                        if (s[f].getTime ?
                            ...
                            var v = g - n / 2 << 0,
                                ...
                                x = 0 === w % 2 ? 0 : 0.5,
                                y = r.dataPointIds[f];
                            this._eventManager.objectMap[y] = { id: y, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: v, y1: k, x2: t, y2: h, x3: g, y3: l, x4: g, y4: m, borderThickness: w, color: d };
                            c.strokeStyle = d;
                            c.beginPath();
                            c.lineWidth = w;
                            ...
                            (s[f].indexLabel || r.indexLabel || s[f].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({ chartType: r.type, dataPoint: s[f], dataSeries: r, point: { x: v + (t - v) / 2, y: a.axisY.reversed ? l : h }, direction: 1, bounds: { x1: v, y1: Math.min(h, l), x2: t, y2: Math.max(h, l) }, color: d })
                        }
            }
            c.restore();
            u && b.restore();
                        ...
                        for (var e = 5 < h && p.bevelEnabled ? !0 : !1, f = 0; f < n.length; f++)
                            if (n[f].getTime ? k = n[f].x.getTime() : k = n[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== n[f].y && n[f].y.length && "number" === typeof n[f].y[0] && "number" === typeof n[f].y[1]) {
                                ...
                                u && M(this._eventManager.ghostCtx, q, d, r, g,
                                    b, 0, null, !1, !1, !1, !1);
                                if (n[f].indexLabel || p.indexLabel || n[f].indexLabelFormatter || p.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeColumn", dataPoint: n[f], dataSeries: p, indexKeyword: 0, point: { x: q + (r - q) / 2, y: n[f].y[1] >= n[f].y[0] ? g : d }, direction: n[f].y[1] >= n[f].y[0] ? -1 : 1, bounds: { x1: q, y1: Math.min(d, g), x2: r, y2: Math.max(d, g) }, color: b }), this._indexLabels.push({
                ...
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)
                        if (e[f].getTime ? h = e[f].x.getTime() : h = e[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== e[f].y && e[f].y.length && "number" === typeof e[f].y[0] && "number" === typeof e[f].y[1]) {
                            ...
                            b = n.dataPointIds[f];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: f, x1: d, y1: k, x2: g, y2: r };
                            b = E(b);
                            ...
                            if (e[f].indexLabel || n.indexLabel || e[f].indexLabelFormatter || n.indexLabelFormatter) this._indexLabels.push({
                                ...
                                dataSeries: n,
                                indexKeyword: 0,
                                point: { x: e[f].y[1] >= e[f].y[0] ? d : g, y: k + (r - k) / 2 },
                                direction: e[f].y[1] >= e[f].y[0] ? -1 : 1,
                                bounds: { x1: Math.min(d, g), y1: k, x2: Math.max(d, g), y2: r },
                                color: b
                            }), this._indexLabels.push({ chartType: "rangeBar", dataPoint: e[f], dataSeries: n, indexKeyword: 1, point: { x: e[f].y[1] >= e[f].y[0] ? g : d, y: k + (r - k) / 2 }, direction: e[f].y[1] >= e[f].y[0] ? 1 : -1, bounds: { x1: Math.min(d, g), y1: k, x2: Math.max(d, g), y2: r }, color: b })
                        }
                }
            }
            c.restore();
    ...
    A.prototype.renderRangeArea = function(a) {
        function c() {
            if (z) {
                ...
                b.globalAlpha = 1;
                d.fill();
                if (0 < l.lineThickness) { b.beginPath();
                    b.moveTo(a.x, a.y);
                    ...
                    for (var A = !0; n < m.length; n++)
                        if (s = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!l.connectNullData ||
                            ...
                            if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                                ...
                                p || A ? (l.connectNullData && !p ? (b.setLineDash && (l.options.nullDataLineDashType || x === l.lineDashType && l.lineDashType !== l.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = B, x = l.nullDataLineDashType, b.setLineDash(y)), b.lineTo(e, q), u && d.lineTo(e, q), k.push({ x: e, y: r })) : (b.beginPath(), b.moveTo(e,
                                    q), z = { x: e, y: q }, k = [], k.push({ x: e, y: r }), u && (d.beginPath(), d.moveTo(e, q))), A = p = !1) : (b.lineTo(e, q), k.push({ x: e, y: r }), u && d.lineTo(e, q), 0 == n % 250 && c());
                                s = l.dataPointIds[n];
                                this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: n, x1: e, y1: q, y2: r };
                                ...
                                if (0 !== m[n].markerSize && (0 < m[n].markerSize || 0 < l.markerSize)) {
                                    ...
                                    f.push(C);
                                    var N = E(s);
                                    u && f.push({ x: e, y: r, ctx: d, type: C.type, size: C.size, color: N, borderColor: N, borderThickness: C.borderThickness });
                                    C = l.getMarkerProperties(n, e, q, b);
                                    f.push(C);
                                    N = E(s);
                                    u && f.push({ x: e, y: q, ctx: d, type: C.type, size: C.size, color: N, borderColor: N, borderThickness: C.borderThickness }) }
                                if (m[n].indexLabel ||
                                    l.indexLabel || m[n].indexLabelFormatter || l.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeArea", dataPoint: m[n], dataSeries: l, indexKeyword: 0, point: { x: e, y: q }, direction: m[n].y[0] > m[n].y[1] === a.axisY.reversed ? -1 : 1, color: v }), this._indexLabels.push({ chartType: "rangeArea", dataPoint: m[n], dataSeries: l, indexKeyword: 1, point: { x: e, y: r }, direction: m[n].y[0] > m[n].y[1] === a.axisY.reversed ? 1 : -1, color: v })
                            } else A || p || c(), A = !0;
                    c();
                    P.drawMarkers(f)
                }
                    ...
                    for (n = !1; m < l.length; m++)
                        if (p = l[m].x.getTime ? l[m].x.getTime() : l[m].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax &&
                            ...
                            if (null !== l[m].y && l[m].y.length && "number" === typeof l[m].y[0] && "number" === typeof l[m].y[1]) {
                                ...
                                this._eventManager.objectMap[y] = { id: y, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: m, x1: p, y1: n, y2: e };
                                q[q.length] = { x: p, y: n };
                                r[r.length] = { x: p, y: e };
                                ...
                                if (0 !== l[m].markerSize && (0 < l[m].markerSize || 0 < h.markerSize)) {
                                    ...
                                    f.push(B);
                                    var A = E(y);
                                    u && f.push({ x: p, y: n, ctx: d, type: B.type, size: B.size, color: A, borderColor: A, borderThickness: B.borderThickness });
                                ...
                                if (l[m].indexLabel || h.indexLabel || l[m].indexLabelFormatter || h.indexLabelFormatter) this._indexLabels.push({ chartType: "splineArea", dataPoint: l[m], dataSeries: h, indexKeyword: 0, point: { x: p, y: n }, direction: l[m].y[0] <= l[m].y[1] ? -1 : 1, color: s }), this._indexLabels.push({ chartType: "splineArea", dataPoint: l[m], dataSeries: h, indexKeyword: 1, point: { x: p, y: e }, direction: l[m].y[0] <= l[m].y[1] ? 1 : -1, color: s });
                                n = !1
    ...
    A.prototype.renderPie = function(a) {
        function c() {
            if (m && p) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < p.length; f++) {
                    var g = p[f],
                        k = m.dataPointIds[f],
                        h = { id: k, objectType: "dataPoint", dataPointIndex: f, dataSeriesIndex: 0 };
                    q.push(h);
                    var n = { percent: null, total: null },
                        r = null,
                        n = l.getPercentAndTotal(m, g);
                    if (m.indexLabelFormatter || g.indexLabelFormatter) r = { chart: l.options, dataSeries: m, dataPoint: g, total: n.total, percent: n.percent };
                    ...
                    if (h.midAngle > Math.PI / 2 - v && h.midAngle < Math.PI / 2 + v) {
                        ...
                        a++ } else if (h.midAngle > 3 * Math.PI / 2 - v && h.midAngle < 3 * Math.PI / 2 + v) {
        ...
        function f(a) {
            for (var b = null, c = 1; c < p.length; c++)
                if (b = (a + c + q.length) % q.length, q[b].hemisphere !== q[a].hemisphere) { b = null;
                    break } else if (q[b].indexLabelText && b !== a && (0 > d(q[b], q[a]) || ("right" === q[a].hemisphere ? q[b].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y : q[b].indexLabelTextBlock.y <=
        ...
        function g(a, b, c) {
            ...
            if (0 <= a && a < p.length) {
                ...
                for (k = 1; k < p.length; k++)
                    if (h =
                        (a - k + q.length) % q.length, q[h].hemisphere !== q[a].hemisphere) { h = null;
                        break } else if (q[h].indexLabelText && q[h].hemisphere === q[a].hemisphere && h !== a && (0 > d(q[h], q[a]) || ("right" === q[a].hemisphere ? q[h].indexLabelTextBlock.y <= q[a].indexLabelTextBlock.y : q[h].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y))) break;
                else h = null;
                n = h;
                m = f(a);
                k = h = 0;
                    ...
                    for (var a = -1, b = -1, c = 0, e = !1, g = 0; g < p.length; g++)
                        if (e = !1, v = q[g], v.indexLabelText) {
                            ...
                            if (null !== k) {
                                ...
                                y = d(v, h);
                                var l;
                                if (l = 0 > y) { l = v.indexLabelTextBlock.x;
            ...
            if (0 !== u) {
                ...
                this.pieDoughnutClickHandler = function(a) {
                    l.isAnimating || !x(a.dataSeries.explodeOnClick) &&
                        !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && l._animator.animate(0, 500, function(a) { b(a);
                            h() }))
                };
                c();
                k();
    ...
    A.prototype.set = function(a, c, b) { b = "undefined" === typeof b ? !0 : b; "options" === a ? (this.options = c, b && this.render()) : A.base.set.call(this, a, c, b) };
    A.prototype.exportChart =
        function(a) { a = "undefined" === typeof a ? {} : a;
    ...
    ha.prototype.unRegisterSpace = function(a, c) { "top" === a ? this._topOccupied -= c.height : "bottom" === a ? this._bottomOccupied -= c.height : "left" === a ? this._leftOccupied -= c.width : "right" === a && (this._rightOccupied -= c.width) };
    ...
    ha.prototype.reset = function() { this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding };
    T(V, L);
    ...
    V.prototype.setText = function(a) { this.text = a;
        this._isDirty = !0;
        this._wrappedText = null };
    ...
    V.prototype._getFontString = function() {
        ...
        var c = this.fontFamily ? this.fontFamily + "" : "";!u && c && (c = c.split(",")[0], "'" !== c[0] && '"' !== c[0] && (c = "'" + c + "'"));
        return a += c };
    T(ma, L);
    ma.prototype.render = function() {
        if (this.text) {
            ...
            g.horizontalAlign = h;
            g.render(!0);
            a.layoutManager.registerSpace(l, { width: this.width + ("left" === l || "right" === l ? this.margin + 2 : 0), height: this.height + ("top" === l || "bottom" === l ? this.margin + 2 : 0) });
    ...
    wa.prototype.render = function() {
            ...
            if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type) {
                ...
                for (var t = 0; t < n.dataPoints.length; t++) {
                    var w = n.dataPoints[t],
                        ...
                        q = w.legendText ? w.legendText : n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: n, dataPoint: w }) : w.name ?
                        ...
                        e = { markerType: e, markerColor: r, text: q, textBlock: null, chartType: n.type, markerSize: s, dataSeriesIndex: p, dataPointIndex: t, markerBorderColor: u, markerBorderThickness: v };
        ...
        this.items = l;
        for (p = 0; p < this.items.length; p++) e = l[p], e.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[e.id] = { id: e.id, objectType: "legendItem", legendItemIndex: p, dataSeriesIndex: e.dataSeriesIndex, dataPointIndex: e.dataPointIndex };
                ...
                if (e) {
                    switch (this.type) {
                        ...
                        case "scatter":
                            ...
                            r <= u && d.push({ dataPoint: q, dataPointIndex: g, dataSeries: this, distance: r });
                            g = Math.abs(e.x1 - a);
                            g <= l ? l = g : 0 < k ? m++ : p++;
                            r <= s / 2 && (h = !0);
                            break;
                        ...
                        case "bubble":
                            s = e.size;
                            r = Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y1 - c, 2));
                            r <= s / 2 && (d.push({ dataPoint: q, dataPointIndex: g, dataSeries: this, distance: r }), h = !0);
                            break;
                        case "pie":
                        case "doughnut":
                            s = e.center;
                        ...
                        case "ohlc":
                            if (Math.abs(e.x2 - a + e.x1 - a) < e.borderThickness && c >= e.y2 && c <= e.y3 || a >= e.x1 && a <= (e.x2 + e.x1) / 2 && c >= e.y1 - e.borderThickness / 2 && c <= e.y1 + e.borderThickness / 2 || a >= (e.x1 + e.x2) / 2 && a <= e.x2 && c >= e.y4 - e.borderThickness /
                                2 && c <= e.y4 + e.borderThickness / 2) d.push({ dataPoint: q, dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(e.x1 - a), Math.abs(e.x2 - a), Math.abs(e.y2 - c), Math.abs(e.y3 - c)) }), h = !0
                    }
    ...
    C.prototype.createLabels = function() {
        ...
        if ("axisX" === this.type && b && !this.logarithmic)
            ...
            for (b = this.intervalStartPosition; b <= f; b = parseFloat((this.logarithmic && this.equidistantInterval ? b * Math.pow(this.logarithmBase,
                    this.interval) : b + this.interval).toFixed(14))) a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: b, label: this.labels[b] ? this.labels[b] : null }) : "axisX" === this.type && this.labels[b] ? this.labels[b] : ba(b, this.valueFormatString, this.chart._cultureInfo), a = new V(this.ctx, {
                x: 0,
                y: 0,
                maxWidth: g,
                maxHeight: k,
    ...
    C.prototype.createLabelsAndCalculateHeight = function() {
        ...
        if ("bottom" === this._position || "top" === this._position) {
            for (b = 0; b < this._labels.length; b++) { c = this._labels[b].textBlock;
                var d = c.measureText(),
                    f = 0,
    ...
    C.setLayoutAndRender = function(a, c, b, d, f, g) {
        ...
        if ("normal" === f) {
            ...
            for (; 4 > q;) {
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e] && (k = Math.round(a[0] ? a[0].lineCoordinates.x2 : c[0].lineCoordinates.x2), l = Math.round(k), D = d[e]._labels && 0 < d[e]._labels.length ? d[e]._labels[d[e]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(g.y1 + U + K < Math.max(D, 10) ? Math.max(D, 10) : g.y1 +
                        U + K), D = 0 < a.length ? 0 : d[e]._labels[0].textBlock.height / 2, m = Math.round(g.y2 - (W + f + D)), d[e].lineCoordinates = { x1: k + O, y1: h, x2: k + O, y2: m, height: Math.abs(m - h) }, d[e].bounds = { x1: k, y1: h, x2: l + (w[e] + O), y2: m, width: l - k, height: m - h }, d[e].title && (d[e]._titleTextBlock.maxWidth = 0 < d[e].titleMaxWidth && d[e].titleMaxWidth < d[e].lineCoordinates.height ? d[e].titleMaxWidth : d[e].lineCoordinates.height), O += w[e] + d[e].margin);
                if (a && 0 < a.length)
            ...
            for (; 4 > q;) {
                ...
                if (d && 0 < d.length)
                    for (e = d.length - 1; 0 <= e; e--) d[e] && (h = Math.round(g.y1), m = Math.round(g.y1 + (A[e] + d[e].margin + Q)), d[e].lineCoordinates.y1 = m, d[e].lineCoordinates.y2 = m, d[e].bounds = { x1: k, y1: h + (d[e].margin + Q), x2: l, y2: m, width: l - k, height: T }, d[e].title && (d[e]._titleTextBlock.maxWidth = 0 <
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) {
                        ...
                        a[e].lineCoordinates = { x1: l - J, y1: h, x2: l - J, y2: m, height: Math.abs(m - h) };
                        a[e].bounds = {
                            x1: l - (B[e] + J),
                            y1: h,
                            x2: l,
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) {
                        ...
                        c[e].lineCoordinates = { x1: l + P, y1: h, x2: l + P, y2: m, height: Math.abs(m - h) };
                        c[e].bounds = { x1: k, y1: h, x2: l, y2: m, width: l - k, height: m - h };
            ...
            if ("bottom" === this._position || "top" === this._position)
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c = [], d = 0 !== this.labelAngle &&
                            360 !== this.labelAngle ? 1 : 1.2, g, k = this.viewportMaximum, h = this.lineCoordinates.width / Math.log(this.range), l = this._labels.length - 1; 0 <= l; l--) { p = this._labels[l];
    ...
    C.prototype.renderStripLinesOfThicknessType = function(a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            ...
            if (!k) {
                ...
                this.ctx.clip();
                for (d = 0; d < h.length; d++) m = h[d], m.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() { this.ctx.save();
                    this.ctx.beginPath();
            ...
            if (this.logarithmic) this.calculateLogarithamicAxisParameters();
                ...
                if (null === this.minimum || null === this.maximum)
                    if ("axisX" === this.type ? (f = null !== this.minimum ? this.minimum : this.dataInfo.min, g = null !== this.maximum ? this.maximum : this.dataInfo.max, 0 === g - f && (d = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval, g += d, f -= d), k = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < g - f ? 0.5 * Math.abs(g - f) : 1) : "axisY" === this.type && (f = null !== this.minimum ? this.minimum : this.dataInfo.min, g = null !== this.maximum ? this.maximum : this.dataInfo.max, isFinite(f) ||
                        ...
                        if (null === this.maximum || isNaN(this.maximum)) this.maximum = g + k / 2 } else this.intervalType = "number", null === this.minimum && (this.minimum = "axisX" === this.type ? f - k / 2 : Math.floor(f / this.interval) * this.interval, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum)),
                ...
                if (!this.valueFormatString && (this.valueFormatString = "#,##0.##", 1 > this.range)) { c = Math.floor(Math.abs(Math.log(this.range) / Math.LN10)) + 2;
    ...
    C.prototype.calculateLogarithamicAxisParameters = function() {
        ...
        if (!this.valueFormatString &&
            (this.valueFormatString = "#,##0.##", 1 > this.viewportMinimum)) { c = Math.floor(Math.abs(Math.log(this.viewportMinimum) / Math.LN10)) + 2;
            if (isNaN(c) || !isFinite(c)) c = 2;
            if (2 < c)
                for (b = 0; b < c - 2; b++) this.valueFormatString += "#" }
    };
    ...
    na.prototype.render = function() {
        ...
        if (0 < c) {
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position) f =
                g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, k = this.chart.plotArea.y1, h = this.chart.plotArea.y2, this.bounds = { x1: f - c / 2, y1: k, x2: g + c / 2, y2: h };
            else if ("left" === this.parent._position || "right" === this.parent._position) k = h = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, f = this.chart.plotArea.x1, g = this.chart.plotArea.x2, this.bounds = { x1: f, y1: k - c / 2, x2: g, y2: h + c / 2 };
            this.ctx.moveTo(f, k);
            this.ctx.lineTo(g, h);
            this.ctx.stroke();
    ...
    R.prototype.mouseMoveHandler = function(a, c) { this._lastUpdated && 40 > (new Date).getTime() - this._lastUpdated || (this._lastUpdated = (new Date).getTime(), this._updateToolTip(a, c)) };
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX)
                        for (var h =
                            ...
                            for (var k = this.chart.axisX[h].convertPixelToValue({ y: c }), l = null, d = 0; d < this.chart.axisX[h].dataSeries.length; d++)(l = this.chart.axisX[h].dataSeries[d].getDataPointAtX(k, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX[h].dataSeries[d], null !== l.dataPoint.y && f.push(l));
                            l = null }
                    if (this.chart.axisX2)
                        for (h = 0; h < this.chart.axisX2.length; h++) {
                            k = this.chart.axisX2[h].convertPixelToValue({ y: c });
                            l = null;
                    ...
                    if (this.chart.axisX)
                        for (h = 0; h < this.chart.axisX.length; h++)
                            for (k = this.chart.axisX[h].convertPixelToValue({ x: a }), l = null, d = 0; d < this.chart.axisX[h].dataSeries.length; d++)(l = this.chart.axisX[h].dataSeries[d].getDataPointAtX(k, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX[h].dataSeries[d], null !== l.dataPoint.y && f.push(l));
                    if (this.chart.axisX2)
                        for (h = 0; h < this.chart.axisX2.length; h++)
                            for (k =
                                this.chart.axisX2[h].convertPixelToValue({ x: a }), l = null, d = 0; d < this.chart.axisX2[h].dataSeries.length; d++)(l = this.chart.axisX2[h].dataSeries[d].getDataPointAtX(k, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX2[h].dataSeries[d], null !== l.dataPoint.y && f.push(l))
                }
                ...
                if (l = this.chart.getDataPointAtXY(a, c, b)) this.currentDataPointIndex =
                    ...
                    if (l = Ma(a, c, this.chart._eventManager.ghostCtx), 0 < l && "undefined" !== typeof this.chart._eventManager.objectMap[l]) { l = this.chart._eventManager.objectMap[l];
    ...
    R.prototype.getToolTipInnerHTML = function(a) {
        ...
        for (var c = null, b = null, d = null, f = 0, g = "", k = !0, h = 0; h < a.length; h++)
            if (a[h].dataSeries.toolTipContent || a[h].dataPoint.toolTipContent) { k = !1;
                break }
    ...
    R.prototype.disableAnimation = function() { this.container.style.WebkitTransition && (this.container.style.WebkitTransition = "", this.container.style.MozTransition = "", this.container.style.MsTransition = "", this.container.style.transition = "") };
    ...
    A.prototype.replaceKeywordsWithValue = function(a, c, b, d, f) {
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
            ...
            try {
                var h = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                h && 0 < h.length && (e = ka(h[2]), a = ka(h[1])) } catch (k) {}
            h = null;
    ...
    var F = {
        ...
        ja = {
            Chart: A,
            addColorSet: function(a, c) { fa[a] = c },
            addCultureInfo: function(a, c) { pa[a] = c },
            formatNumber: function(a, c, b) { b = b || "en";
